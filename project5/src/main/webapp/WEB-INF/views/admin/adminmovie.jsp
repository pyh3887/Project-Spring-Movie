  ...
  <div class="wrapper">
    ...
    <div class="main-panel" style="height: 100vh;">
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
            <h3 class="description">영화관리</h3>
            
            <!-- insert modal -->
<form id="uploadFile" action="movieinsert" method="post" enctype="multipart/form-data" name="frm2">
<div class="modal fade" id="squarespaceModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
			<h3 class="modal-title" id="lineModalLabel">영화 목록 추가하기</h3>
		</div>
		...
		<div class="modal-body">
            ...
            <!-- content goes here --> 
              ...
              <div class="form-group" style="width: 45%; float: left;">
               ...
               <div >
                <label for="exampleInputPassword1">영화 줄거리</label>
	...
	<form action="adminmoviepart" name="frm" method="get">
	...
	<div class="modal fade" id="exampleModal${vs.index }" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  	<div class="modal-dialog" role="document">
   	 <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">영화삭제</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="location.href='moviedelete?name=${list.name}'">삭제</button>
    ...
    <form  action="movieupdate" method="post" enctype="multipart/form-data" name="frm3">
...
<div class="modal fade" id="modalbox" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
			<h3 class="modal-title" id="lineModalLabel">영화 목록 수정하기</h3>
		</div>
		...
		<div class="modal-body">
            ...
            <!-- content goes here --> 
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">예고편 링크</label>
                <input type="text" class="form-control" placeholder="url" name="preview" id = 'preview' required="required">    
              </div>
                
              <div class="form-group">
                <label for="exampleInputPassword1">출연진</label>
                <input type="text" class="form-control"  placeholder=",로 구분" name="actor_name" id= 'actor' required>    
              </div>
            ...
            <input type="hidden" class="name" id='abc' name="common" value="">  
